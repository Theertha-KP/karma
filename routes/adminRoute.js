...
//admin_route.route("/addproduct").get(adminmiddle.checkAdmin, productController.loadAddproduct).post(adminmiddle.checkAdmin, upload.array("files", 5), productController.insertProductDb)
